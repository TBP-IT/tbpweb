...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HouseMember.is_leader'
        db.alter_column(u'houses_housemember', 'is_leader', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'HouseMember.is_leader'
        db.alter_column(u'houses_housemember', 'is_leader', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'houses.housemember': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_leader': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
