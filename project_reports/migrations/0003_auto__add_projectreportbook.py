...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectReportBook'
        db.create_table(u'project_reports_projectreportbook', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('presidents_letter', self.gf('django.db.models.fields.TextField')()),
            ('pdf', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('exception', self.gf('picklefield.fields.PickledObjectField')(null=True)),
        ))
        db.send_create_signal(u'project_reports', ['ProjectReportBook'])

        # Adding M2M table for field terms on 'ProjectReportBook'
        m2m_table_name = db.shorten_name(u'project_reports_projectreportbook_terms')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('projectreportbook', models.ForeignKey(orm[u'project_reports.projectreportbook'], null=False)),
            ('term', models.ForeignKey(orm[u'base.term'], null=False))
        ))
        db.create_unique(m2m_table_name, ['projectreportbook_id', 'term_id'])


    def backwards(self, orm):
        # Deleting model 'ProjectReportBook'
        db.delete_table(u'project_reports_projectreportbook')

        # Removing M2M table for field terms on 'ProjectReportBook'
        db.delete_table(db.shorten_name(u'project_reports_projectreportbook_terms'))
    ...
    models = {
        ...
        u'project_reports.projectreportbook': {
            'Meta': {'object_name': 'ProjectReportBook'},
            'exception': ('picklefield.fields.PickledObjectField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pdf': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
            'presidents_letter': ('django.db.models.fields.TextField', [], {}),
            'terms': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['base.Term']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'project_reports.projectreportfromemail': {
            'Meta': {'ordering': "('name',)", 'object_name': 'ProjectReportFromEmail'},
