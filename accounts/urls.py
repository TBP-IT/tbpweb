...
urlpatterns = [
    ...
    re_path(r'password/reset/$', password_reset,
        {'template_name': 'accounts/password_reset.html',
         ...
         'current_app': app_name},
        name='password-reset'),
    re_path(r'password/reset/sent/$', password_reset_done,
    ...
    re_path(r'^password/reset/complete/', password_reset_complete,
